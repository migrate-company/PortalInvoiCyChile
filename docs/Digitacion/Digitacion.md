# InvoiCy Digitación en Pantalla

¡Hola! Con el objetivo de facilitar la emisión de documentos electrónicos, InvoiCy dispone de la funcionalidad de **Digitación en Pantalla**, que permite ingresar los datos directamente desde la plataforma, sin necesidad de realizar una integración con la API de InvoiCy.

Esta funcionalidad permite a las empresas emitir sus documentos de forma rápida, sencilla y segura, realizando el ingreso de la información necesaria directamente desde las pantallas disponibles en InvoiCy.
